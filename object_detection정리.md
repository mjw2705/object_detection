...
![ssd](./img/ssd.png)  
mAP: 72.1%, FPS:58  
detail 정보를 보존하기 위해 각 스케일에 대해 detector & classifier 수행  
Pyramidal feature hierarchy 구조

1. 300 x 300 input image를 학습된 VGG-16에 통과, conv4_3까지 적용해 feature map(38 x 38x 512) 추출
